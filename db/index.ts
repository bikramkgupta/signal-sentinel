 ...
 * Prefers DATABASE_PRIVATE_URL (VPC) over DATABASE_URL (public) for trusted sources
 */
function loadPgEnvConfig(): PgEnvConfig {
  const rawConnectionString = process.env.DATABASE_PRIVATE_URL || process.env.DATABASE_URL;
