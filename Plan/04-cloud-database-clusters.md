...
Create managed database clusters in DigitalOcean.
...
- [x] Cluster created
- [x] Cluster ID saved to `.env.secrets` as `PG_ID`
...
- [x] Cluster created
- [x] Cluster ID saved to `.env.secrets` as `KAFKA_ID`
...
- [x] Cluster created
- [x] Cluster ID saved to `.env.secrets` as `OS_ID`

### 4.4 Create Spaces Bucket

- [x] Bucket created in region
...
| Kafka cluster online | [x] |
| OpenSearch cluster online | [x] |
