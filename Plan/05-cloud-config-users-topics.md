...
- [x] Database created
- [x] User created
- [x] Password saved to `.env.secrets`
...
- [x] Topic `signals.raw.v1` created
- [x] Topic `signals.ai.jobs.v1` created
- [x] Topic `signals.dlq.v1` created
...
- [x] All connection info captured to `.env.secrets`
